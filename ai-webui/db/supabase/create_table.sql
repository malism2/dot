...
create table if not exists public.navigation_category (
  ...
  create table if not exists public.navigation_category_i18n (
    id bigint GENERATED BY DEFAULT AS IDENTITY,
    category_id bigint REFERENCES navigation_category(id),
...
CREATE TABLE IF NOT EXISTS public.web_navigation_i18n (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name TEXT REFERENCES web_navigation(name),
  locale text NOT NULL,  -- 语言代码，如en、cn、ja
  title text,  -- 该语言的标题
  content text,  -- 该语言的内容
  detail text,  -- 该语言的详情
